resource "aws_iam_policy" "sgp-uat-policy-lbd-start-stop-ec2" { 
    ...
    path         = "/"
    description  = "Policy for Lambda function to control start and stop of EC2,RDS instances"
...
resource "aws_iam_role" "sgp-uat-role-lbd-start-stop-ec2" {
    ...
    path        = "/"
    description = "Allows Lambda function to control start and stop of EC2, RDS instances."
